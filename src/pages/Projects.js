    ...
    <div className='px-[100px] pt-[90px] snap-start snap-always'>
        ...
        <div class="grid gap-4 grid-cols-3 grid-rows-3 mt-[50px]">
            ...
            <div className='flex flex-col border-2 border-slate-600 text-left rounded-xl'>
                <label className='my-[15px] text-3xl px-[10px] underline decoration-wavy underline-offset-4'>Cerø</label>
            ...
            <div className='flex flex-col border-2 border-slate-600 text-left rounded-xl'>
                <label className='my-[15px] text-3xl px-[10px] underline decoration-wavy underline-offset-4'>SuperStream</label>
            ...
            <div className='flex flex-col border-2 border-slate-600 text-left rounded-xl'>
                <label className='my-[15px] text-3xl px-[10px] underline decoration-wavy underline-offset-4'>VoteChain</label>
            ...
            <div className='flex flex-col border-2 border-slate-600 text-left rounded-xl'>
                <label className='my-[15px] text-3xl px-[10px] underline decoration-wavy underline-offset-4'>Cryptoverse</label>
            ...
            <div className='flex flex-col border-2 border-slate-600 text-left rounded-xl'>
                <label className='my-[15px] text-3xl px-[10px] underline decoration-wavy underline-offset-4'>Event Logger</label>
            ...
            <div className='flex flex-col border-2 border-slate-600 text-left rounded-xl'>
                <label className='my-[15px] text-3xl px-[10px] underline decoration-wavy underline-offset-4'>Searchit</label>
